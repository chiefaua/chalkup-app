...
import static de.chalkup.app.widget.TouchImageView.State.ANIMATE_ZOOM;
import static de.chalkup.app.widget.TouchImageView.State.DRAG;
import static de.chalkup.app.widget.TouchImageView.State.FLING;
import static de.chalkup.app.widget.TouchImageView.State.NONE;
import static de.chalkup.app.widget.TouchImageView.State.ZOOM;
...
public class TouchImageView extends ImageView {
    ...
    private float superMinScale = SUPER_MIN_MULTIPLIER * minScale;
    private float maxScale = 3;
    private float superMaxScale = SUPER_MAX_MULTIPLIER * maxScale;
    ...
    //
    private boolean maintainZoomAfterSetImage = true;
    //
